...
<div class="card mb-5">
    ...
    <div class="card-body">
      ...
      <a href="{{ $posts[0]->user->name }}" class="text-decoration-none text-dark"><h6 class="card-subtitle">Pembuat : {{ $posts[0]->user->name }}</h6></a>
      <a href="project/kategori/{{ $posts[0]->kategori->nama_kategori }}" class="text-decoration-none text-dark"><p class="card-text fs-5 my-3">Kategori : {{ $posts[0]->kategori->nama_kategori }}</p></a>
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body my-1">
                  ...
                  <a href="{{ $post->user->name }}" class="text-decoration-none text-dark"><h6 class="card-subtitle my-3">Pembuat : {{ $post->user->name }}</h6></a>
