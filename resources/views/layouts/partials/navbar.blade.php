<nav class="navbar bg-danger navbar-expand-lg ">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('/') ? 'text-dark' : 'text-white' }}" aria-current="page"
                        href="/">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('project') ? 'text-dark' : 'text-white' }}"
                        href="/project">Project</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('kategori') ? 'text-dark' : 'text-white' }}"
            ...
            <ul class="navbar-nav ms-auto ">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('login') ? 'text-dark' : 'text-white' }}" href="/login"><i
